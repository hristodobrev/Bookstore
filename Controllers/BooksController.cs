...
namespace Bookstore.Controllers
{
	public class BooksController : Controller
	{
		...
		{
			ViewData["AuthorId"] = new SelectList(_context.Authors.Select(s => new { Id = s.Id, Name = $"{s.FirstName} {s.LastName}" }), "Id", "Name");
		...
		public IActionResult Create([Bind("Id,Title,Genre,Price,ReleaseDate,AuthorId")] Book book)
		{
			...
			ViewData["AuthorId"] = new SelectList(_context.Authors.Select(s => new { Id = s.Id, Name = $"{s.FirstName} {s.LastName}" }), "Id", "Name", book.AuthorId);
